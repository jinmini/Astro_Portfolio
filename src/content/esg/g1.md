...
techStack: ['Python', 'BERT', 'FastAPI', 'React', 'Next.js']
achievements: [
...
---
삼정회계법인 KPMG와 협력하여 기업의 ESG 데이터 분석을 통한 보고서 자동화 및 공시 대응 역량을 강화하고, 전략 수립과 위험 평가를 위한 자동화 솔루션을 제안하는 SaaS 플랫폼을 개발했습니다.
NLP 기술로 프레임워크 자동 매핑 엔진을 개발해 정확도 향상을 목표로 했습니다.